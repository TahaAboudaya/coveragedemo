        ...
        <div class="container mx-auto p-16">
            <div class="flex flex-nowrap flex-row-reverse -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded-full  py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white text-right" id="name" type="text" placeholder="name" name="name">
                </div>
                <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase text-right tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                        service number
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded-full py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-right" id="service_num" type="text" placeholder="service_num" name="service_num">
                </div>
                <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase text-right tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-last-name">
                        Phone number
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded-full py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 text-right" id="phone" type="text" placeholder="phone" name="phone">
                </div>
